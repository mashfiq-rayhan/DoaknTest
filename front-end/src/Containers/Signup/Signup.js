						...
						<div className={classes.FormDiv}>
							...
							<div className={classes.GenderOptions}>
								<input
									...
									required
								/>
								<label className={classes.GenderOption} htmlFor="male">
									Male
								</label>
							</div>
							<div className={classes.GenderOptions}>
								<input
									...
									required
								/>
								<label className={classes.GenderOption} htmlFor="female">
									Female
								</label>
							</div>
							<div className={classes.GenderOptions}>
								<input
									...
									required
								/>
								<label className={classes.GenderOption} htmlFor="other">
									Custom
								</label>
							</div>
